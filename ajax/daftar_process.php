...
{ 
  $remail = $xss_clean->clean_input(aman($_POST['remail']));
  $rnama = $xss_clean->clean_input(aman($_POST['rnama']));
  
  $rpass = $xss_clean->clean_input(aman($_POST['rpass']));
  $jk = $xss_clean->clean_input(aman($_POST['jk']));
  
  $passkey = md5(uniqid(rand()));
  
  $stmt = $user_home->runQuery("SELECT * FROM login WHERE email=:user_mail");
  $stmt->execute(array(":user_mail"=>$remail));
  ...
  {
    if($user_home->register_member($remail,$rnama,$rpass,$passkey,$jk))
    {
      
      $key = base64_encode($remail);
      $id = $key;

		$nama_admin="Sistem Mailer Ayo Klarifikasi";
$email_admin="mailer@ayoklarifikasi.com";
$headers ='X-Mailer: PHP/' . phpversion();
$headers .= "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
$headers .= 'Reply-To: '.$remail.'<'.$remail.'>'. "\r\n";
$headers .= 'From: Ayo Klarifikasi <'.$email_admin.'>'. "\r\n";
...
<table class="table-row" width="450" bgcolor="#FFFFFF" style="table-layout: fixed; background-color: #ffffff;" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="table-row-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
    ...
    <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; align: center" align="center">
      ...
      <br><br>
      Silahkan klik link Verifikasi Akun dibawah ini agar anda dapat Login ke Website kami dan Password anda adalah <b><font color="#478fca">'.$rpass.'</font></b>.
      <br> Terimakasih Sudah Bergabung
    </div>
  </td></tr></tbody></table>
</td></tr></tbody></table>
...
<table class="table-row" width="450" bgcolor="#FFFFFF" style="table-layout: fixed; background-color: #ffffff;" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="table-row-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
    <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
      <a href="http://ayoklarifikasi.com/verifikasi.html?id='.$id.'&passkey='.$passkey.'#verifikasi" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Verifikasi Akun &nbsp;</a>
    </div>
...
<table class="table-row-fixed" width="450" bgcolor="#FFFFFF" style="table-layout: fixed; background-color: #ffffff;" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="table-row-fixed-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 1px; padding-right: 1px;" valign="top" align="left">
  <table class="table-col" align="left" width="448" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="448" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
   ...
   <br><font color="#dd5a43">Jangan balas Email ini, Email Ini adalah Email otomatis.</font><br>
      <a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;">Ayo Klarifikasi Team &copy; 2017</a>
      <br>
      <a href="https://twitter.com/ayoklarifikasi" target="_blank" style="color: #478fca; text-decoration: none; background-color: transparent;">twitter</a>
      .
      <a href="https://www.facebook.com/ayoklarifikasi/" target="_blank" style="color: #5b7a91; text-decoration: none; background-color: transparent;">facebook</a>
      .
...
$send = mail($remail,"Verifikasi Email", $pesan, $headers);
