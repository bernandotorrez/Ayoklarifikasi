...
<?php 
  ...
  require_once  '../class.user.php';
                     ...
                     $user_home = new USER();
  $date = date('Y-m-d');
              $sql=mysqli_query($con,"SELECT * FROM posting, member where posting.email=member.email order by view DESC LIMIT 5");
                                ...
                                <div class="col-md-7">
                                     <div class="content">
                                        <p class="category text-danger">
                                            <i class="fa fa-fire text-danger"></i> Isu Terhangat
                                        </p>
                                      ...
                                      <?php } ?> <?php echo $row1['nama_member'];?>
                                            ...
                                            <div class="stats">
                                                ...
                                                <i class="fa fa-eye"></i> <?php echo $row1['view'];?> Dilihat
