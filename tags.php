...
$tags = $_GET['tags'];
              $sql=mysqli_query($con,"SELECT * FROM tags, posting, member WHERE tags.id_posting=posting.id_posting AND posting.email=member.email AND tags.name LIKE '%".$tags."%'");
            $count=mysqli_num_rows($sql);
              if($count < 1) {
                echo "<b><h3>Isu dengan tags : <font class='text-info'>'".$tags."'</font> Tidak ditemukan </h3><b>";
              } else {
                                ...
                                <div class="col-md-7">
                                     <div class="content">
                                       <p class="category text-info">
                                            <i class="fa fa-tags text-info"></i> Tags : <?php echo $tags;?>
                                        </p>
